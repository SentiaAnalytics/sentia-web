...
module.exports = function($scope, $routeParams,  ReportService) {
  'use strict';
  ...
  function updateRevenue () {
    ...
    ReportService.getTotalRevenue($scope.store._id, $scope.date)
      .then(function (total) {
  ...
  function updateTransactions () {
    ...
    ReportService.getTotalTransactions($scope.store._id, $scope.date)
      .then(function (total) {
